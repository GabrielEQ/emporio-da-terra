<?php
/*
 * This file is part of the MinifyJS package.
 *
 ...
 * MinifyJS
 *
 * Usage - MinifyJS::minify($js);
 * Usage - MinifyJS::minify($js, $options);
 * Usage - MinifyJS::minify($js, array('flaggedComments' => false));
 *
 * @package Minify
 * @author Robert Hafner <tedivm@tedivm.com>
...
class MinifyJS
{
    ...
    public static function minify($js, $options = array())
    {
        try {
            ...
            $obj = new MinifyJS();
            $js = $obj->lock($js);
            $obj->minifyDirectToOutput($js, $options);
