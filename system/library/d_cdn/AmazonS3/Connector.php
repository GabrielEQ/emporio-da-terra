...
use AmazonS3\Exception\CannotDeleteFile;
use AmazonS3\Exception\CannotGetBucket;
use AmazonS3\Exception\CannotGetFile;
use AmazonS3\Exception\CannotListBuckets;
use AmazonS3\Exception\CannotOpenFileForWrite;
use AmazonS3\Exception\CannotPutFile;
use AmazonS3\Response\Error;
